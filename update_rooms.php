<?php
    ...
    if (isset($_POST['update'])) {
        ...
        $stmt = $conn->prepare("UPDATE rooms SET room_name=:room_name, room_description=:room_description WHERE id=:id");
        $stmt->bindParam(':id', $id);
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="room_name" class="form-control" value="<?= $row['room_name'] ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-4">
                                    <div class="mb-4">
                                        <label>room description</label>
                                        <input type="text" name="room_description" class="form-control" value="<?= $row['room_description'] ?>" required>
                                    </div>
                                </div>
