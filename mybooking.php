            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container shadow rounded">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>Table Booking</h4>
                        <a href="index.php" class="btn btn-primary my-4"><i class="fa-solid fa-plus"></i> Add Booking</a>
                    </div>
                    <div class="row ">
                        ...
                        <table class="table table-striped table-bordered table-hover shadow-sm">
                            ...
                            <tr class="text-center">
                                ...
                                <?php }else { ?>
                                    <td class="align-middle"><a href="cancel.php?delete_id=<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to cancel?')"><i class="fa-solid fa-xmark"></i> cancel</a></td>
                                <?php } ?>
                            </tr>
                            <?php } }else { ?>
