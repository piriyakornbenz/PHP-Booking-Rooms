            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <nav aria-label="breadcrumb" class="bg-light mt-4 rounded">
                    <ol class="breadcrumb p-2">
                        <li class="breadcrumb-item"><a href="mybooking_admin.php">My Booking</a></li>
                    ...
                    <div class="row ">
                        ...
                        <table class="table table-striped table-bordered table-hover shadow-sm">
                            ...
                            <tr class="text-center">
                                ...
                                <?php }else { ?>
                                    <td class="align-middle"><a href="cancel_admin.php?delete_id=<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to cancel?')">cancel</a></td>
                                <?php } ?>
                            </tr>
                            <?php } }else { ?>
